...
const PROJECT_PROPERTIES = [
    ...
    { name: 'client_address_line', title: 'Street address', type: 'string' },
    { name: 'client_address_country', title: 'Country', type: 'string' },
    { name: 'client_address_zip', title: 'Zip / Postal code', type: 'string' },
    { name: 'client_address_state', title: 'State / Region', type: 'string' },
    { name: 'client_address_city', title: 'City', type: 'string' },
    { name: 'project_name', title: 'Project name', type: 'string', validation: { required: true } },
    { name: 'project_address_line', title: 'Street address', type: 'string' },
    { name: 'project_address_country', title: 'Country', type: 'string' },
    { name: 'project_address_zip', title: 'Zip / Postal code', type: 'string' },
    { name: 'project_address_state', title: 'State / Region', type: 'string' },
    { name: 'project_address_city', title: 'City', type: 'string' },
    { name: 'shipping_notes', title: 'Shipping notes', type: 'string' },
    { name: 'project_notes', title: 'Project notes', type: 'string' },
    { name: 'lead_time', title: 'Lead time (weeks)', type: 'number' },
