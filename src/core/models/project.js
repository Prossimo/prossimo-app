...
const PROJECT_PROPERTIES = [
    ...
    { name: 'client_address_line', title: 'Client address line', type: 'string' },
    { name: 'client_address_country', title: 'Client address country', type: 'string' },
    { name: 'client_address_zip', title: 'Client address zip', type: 'string' },
    { name: 'client_address_state', title: 'Client address state', type: 'string' },
    { name: 'client_address_city', title: 'Client address city', type: 'string' },
    { name: 'project_name', title: 'Project Name', type: 'string' },
    { name: 'project_address_line', title: 'Project address line', type: 'string' },
    { name: 'project_address_country', title: 'Project address country', type: 'string' },
    { name: 'project_address_zip', title: 'Project address zip', type: 'string' },
    { name: 'project_address_state', title: 'Project address state', type: 'string' },
    { name: 'project_address_city', title: 'Project address city', type: 'string' },
