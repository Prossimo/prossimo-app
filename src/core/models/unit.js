...
const Unit = Backbone.Model.extend({
    ...
    sync: function (method, model, options) {
        ...
        if (method === 'create' || method === 'update') {
            options.attrs = {
                project_unit: _.extendOwn(_.omit(model.toJSON(), properties_to_omit), {
    ...
    parse: function (data) {
        ...
        return Schema.parseAccordingToSchema(unit_data, this.schema);
    },
    ...
    getSectionsListWithEstimatedPrices: function () {
        ...
        _.each(sections_list, function (section) {
                ...
                if (section_area < getArea(pricing_grid[0])) {
                    ...
                    _.some(pricing_grid, function (pricing_tier, tier_index) {
                        if (section_area === getArea(pricing_tier)) {
                            ...
                            section.price_per_square_meter = utils.math.linear_interpolation(
                                section_area,
            ...
            section.estimated_price = utils.math.square_meters(section.width, section.height) *
