...
test('FillingTypeProfile model tests', () => {
    ...
    test('parse function', () => {
        ...
        const extra_ftp = new FillingTypeProfile({
            profile_id: 33,
            profile: {
                id: 12,
                name: 'Random Profile',
    ...
    test('toJSON function', () => {
        const default_ftp = new FillingTypeProfile();
    ...
    test('getPricingData function', () => {
        const parent_filling_type = new FillingType({ pricing_scheme: 'PRICING_GRIDS' });
        const default_ftp = new FillingTypeProfile();
        parent_filling_type.get('filling_type_profiles').add(default_ftp);
        const pricing_data = default_ftp.getPricingData();
    ...
    test('change events bubble up properly', () => {
        const ftp = new FillingTypeProfile({
            profile_id: 15,
            is_default: true,
            pricing_grids: [
        ...
        const grid_collection = ftp.get('pricing_grids');
