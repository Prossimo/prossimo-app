...
test('Unit option test', () => {
    test('UnitOption model basic tests', () => {
        const unit_option = new UnitOption();
    ...
    test('UnitOption parse function', () => {
        const data_to_set = {
            id: 45,
            dictionary_id: 12,
        ...
        const unit_option = new UnitOption(data_to_set, { parse: true });
    ...
    test('UnitOption toJSON function', () => {
        const data_to_set = {
            id: 45,
            dictionary_id: 12,
            dictionary_entry_id: 33,
        ...
        const default_unit_option = new UnitOption();
        const predefined_unit_option = new UnitOption(data_to_set, { parse: true });
