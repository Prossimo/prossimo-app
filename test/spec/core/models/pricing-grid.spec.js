...
test('Pricing grid', () => {
    ...
    test('pricing grid parse function', () => {
        const data_to_set = [
    ...
    test('pricing grid getValue function', () => {
        const grid = new PricingGrid();
    ...
    test('pricing grid toJSON function', () => {
        const default_grid = new PricingGrid({
            name: 'default',
        });
        ...
        const fixed_grid = new PricingGrid({
            name: 'fixed',
            data: [
                { height: 500, width: 500, value: 15 },
                { height: 914, width: 1514, value: 12 },
    ...
    test('pricing grid change events bubble up properly', () => {
        const grid = new PricingGrid({
            name: 'fixed',
            data: [
                { height: 500, width: 500, value: 15 },
        ...
        const grid_item = grid.get('data').at(0);
