...
test('DictionaryEntryProfile tests', function () {
    test('DictionaryEntryProfile model basic tests', function () {
        let dep = new DictionaryEntryProfile();
    ...
    test('DictionaryEntryProfile parse function', function () {
        ...
        let another_dep = new DictionaryEntryProfile({
        ...
        let extra_dep = new DictionaryEntryProfile({
            profile_id: 33,
            profile: {
                id: 12,
                name: 'Random Profile'
    ...
    test('DictionaryEntryProfile toJSON function', function () {
        let default_dep = new DictionaryEntryProfile();
    ...
    test('DictionaryEntryProfile getPricingData function', function () {
        ...
        let dep_within_collection = dictionary.entries.at(0).get('dictionary_entry_profiles').at(0);
    ...
    test('DictionaryEntryProfile change events bubble up properly', function () {
        ...
        let grid_collection = dep.get('pricing_grids');
