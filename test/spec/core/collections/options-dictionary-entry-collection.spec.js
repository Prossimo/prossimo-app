...
test('Dictionary entry collection', function () {
    //  ------------------------------------------------------------------------
    //  Collection of dictionary entries
    //  ------------------------------------------------------------------------
    test('dictionary entry collection basic tests', function () {
        let collection = new OptionsDictionaryEntryCollection();
        ...
        let white_plastic = collection.getByName('White Plastic Handle');
