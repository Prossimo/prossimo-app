...
test('Options dictionary collection tests', () => {
    //  ------------------------------------------------------------------------
    //  Collection of dictionaries
    //  ------------------------------------------------------------------------
    test('dictionary collection base functions', () => {
        const dictionaries = new OptionsDictionaryCollection([
            {
                name: 'Interior Handle',
                id: 1,
            },
        ]);
        const handles = dictionaries.get(1);
    ...
    test('dictionary collection getAvailableOptions, getDefaultOption, getFirstAvailableOption, getDefaultOrFirstAvailableOption', () => {
        const dictionaries = new OptionsDictionaryCollection([
            {
                name: 'Interior Handle',
                id: 1,
    ...
    test('dictionary collection getDictionaryIdByName, getDictionaryEntryIdByName, getAvailableDictionaryNames', () => {
        const dictionaries = new OptionsDictionaryCollection([
            {
                name: 'Interior Handle',
                id: 1,
