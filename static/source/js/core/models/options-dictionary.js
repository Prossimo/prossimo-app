...
import OptionsDictionaryEntryCollection from '../collections/options-dictionary-entry-collection';
    ...
    //  TODO: should `rules_and_restrctions` here be an array? or inline model?var DICTIONARY_PROPERTIES = [
...
export default Backbone.Model.extend({
    ...
    parse: function (data) {
        ...
        var filtered_data = Schema.parseAccordingToSchema(dictionary_data, this.schema);
            ...
            //  but we want them backif ( dictionary_data && dictionary_data.entries ) {
