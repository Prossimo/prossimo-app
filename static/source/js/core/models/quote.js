...
(function () {
    ...
    app.Quote = Backbone.Model.extend({
        ...
        parse: function (data) {
            ...
            var filtered_data = app.schema.parseAccordingToSchema(quote_data, this.schema);
        ...
        initialize: function (attributes, options) {
            ...
            if ( !this.options.proxy ) {
                this.units = new app.UnitCollection(null, {
                    quote: this,
                    project: this.collection && this.collection.options.project
                });
                this.extras = new app.AccessoryCollection(null, {
                    quote: this,
                    project: this.collection && this.collection.options.project
                });
