...
import Schema from '../../schema';
    ...
    { name: 'pricing_scheme',title: 'Pricing Scheme', type: 'string' },
            { name: 'pricing_grids',
                title: 'Pricing Grids', type: 'collection:PricingGridCollection' },
                {
    ...
    defaults: function () {
        ...
        var type_value_hash = {
            ...
            var name_value_hash = {
                ...
                low_threshold: false,
                threshold_width: 20,
                pricing_scheme: this.getPossiblePricingSchemes()[0],pricing_grids: new app.PricingGridCollection(null, { append_default_grids: true }),
